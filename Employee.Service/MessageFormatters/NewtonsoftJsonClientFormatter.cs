...
namespace Employee.Service.MessageFormatters
{
    class NewtonsoftJsonClientFormatter : IClientMessageFormatter
    {
        ...
        public Message SerializeRequest(MessageVersion messageVersion, object[] parameters)
        {
            ...
            Message requestMessage = Message.CreateMessage(messageVersion, this.operation.Messages[0].Action, new RawBodyWriter(body));
            requestMessage.Headers.To = this.operationUri;
